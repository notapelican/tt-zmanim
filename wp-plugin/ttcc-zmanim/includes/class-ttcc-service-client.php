...
class TTCC_Zmanim_Service_Client {
	...
	private static function render_payload( $doc, $variant, $design, $allow_modern = true ) {
		...
		foreach ( array(
			...
			'header_font', 'header_size', 'header_align', 'header_custom',
			'subheader_font', 'subheader_size', 'subheader_align', 'subheader_custom',
			'logo_size', 'bsd_font', 'bsd_custom', 'bsd_size', 'page_margin', 'fit_mode', 'text_color', 'callout_bg', 'callout_text',
		) as $k ) {
