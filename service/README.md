...
| POST | `/day` | `{start, end}` | `{days:[…], engine_version}` — per-day zmanim, luach labels, Hebrew date (words **and** letters) and Chabad days, for the display screens. Neutral, not display-shaped |
